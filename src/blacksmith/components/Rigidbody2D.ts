...
export class Rigidbody2D extends Component {
    ...
    public set bodyType(bodyType: b2BodyType) {
        ...
        if (this.body != null)
            this.body.SetType(this._bodyType);
    }
    ...
    public set gravityScale(value: number) {
        ...
        if (this.body != null)
            this.body.SetGravityScale(this._gravityScale);
    }
    ...
    public set linearDamping(value: number) {
        ...
        if (this.body != null)
            this.body.SetLinearDamping(this._linearDamping);
    }
    ...
    public set angularDamping(value: number) {
        ...
        if (this.body != null)
            this.body.SetAngularDamping(this._angularDamping);
    }
    ...
    public set angularVelocity(value: number) {
        ...
        if (this.body != null)
            this.body.SetAngularVelocity(this._angularVelocity);
    }
    ...
    awake(): void {
        this._transform2D = this.gameObject.getComponent(Transform2D) as Transform2D;
        ...
        this._bodyDef.linearVelocity.Set(this._linearVelocity.x, this._linearVelocity.y);
        this._bodyDef.fixedRotation = this._fixedRotation;

        this.body = this.gameObject.engine.physicsSystem2D.world.CreateBody(this._bodyDef);

        this.setPosition(this._transform2D.position.x, this._transform2D.position.y);
